...
<head>
    ...
    <!-- Title Page-->
    <title>Voucher Reserva Mis Alquileres</title>
...
<body>
    <div class="page-wrapper bg-gra-02 p-t-20 p-b-100 font-poppins">
      <center> <img class="sol-de-acuario-top img-responsive" src="<?php echo $dir_img_logo ?>" alt="Voucher Reserva" title="Voucher Reserva" style ="width: 200px"></center>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-md-6 col-lg-6">
                      <center>
                        <h2>Voucher Reserva</h2>
                        <p class="tit1_voucher"><?php echo $Reserva->Cliente->nombre ?> <?php echo $Reserva->Cliente->apellido ?> </p>
                        <p>Celular: {{ $Reserva->Cliente->celular }} </p>
                        <p>Correo: {{ $Reserva->Cliente->email_correo }} </p>
                    ...
                    <div class="col-xs-12 col-md-6 col-lg-6">
                      ...
                      <table class="table table-hover">
                        <tbody>
                          ...
                          <tr>
                            <td></td>
                            <td><i class="fa fa-calendar-check-o"></i> Reserva Pagada</td>
