                ...
                <tr>
                    <td>
                      <div class="btn-group">
                        ...
                        ?>
                       <button type="button" class="btn btn-info <?php echo $class_btn_accion ?>" onclick="window.location = '<?php echo env('PATH_PUBLIC').$accion_extra_url.'/'.$gen_fila[$gen_campos[0]['nombre']]; ?>'" alt="<?php echo $accion_extra_nombre; ?>" title="<?php echo $accion_extra_nombre; ?>"><i class="<?php echo $accion_extra_class; ?>"></i></button>
                        <?php
                            }
                          }
                        }                        
